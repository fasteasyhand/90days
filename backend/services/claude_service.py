            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "- A visa stamp typically has MULTIPLE dates (issue date, entry date, expiry).\n"
                        "- HEURISTIC: Among all dates visible on the visa page, the expiry date is ALWAYS the LATEST/FURTHEST-IN-THE-FUTURE one. If you see dates like 25/04/2025, 25/04/2026, 25/04/2027 — the expiry is 25/04/2027 (the latest).\n"
                        "- Prefer the top-right position, but if ambiguous, pick the LATEST date among all visible dates.\n"
